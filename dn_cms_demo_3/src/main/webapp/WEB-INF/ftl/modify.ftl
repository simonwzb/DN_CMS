<div class="pageContent">
	<form method="post" action="${webRoot}management/modifyAjax"
		...
		<div class="pageFormContent" layoutH="58">
			...
			<p>
				<label>所属栏目：</label> <select name="channel.id"
			...
			<p>
				<label>文章名 ：</label> <input type="text" name="name" size="30"
					value="${article.name}" alt="请输入文章名" />
			</p>
			<p>
				<label>作 者 ：</label> <input type="text" name="author" size="30"
					value="${article.author?default('')}" alt="请输入作者" />
			</p>
			<p>
				<label>摘   要：</lable><br/>
				<textarea name="overview" cols="90" rows="3" >${article.overview?default('')}
				</textarea>
			</p>
			<div class="unit">
			<br/><br/><br/><hr/>
				<textarea class="editor" name="mainBody" rows="100" cols="120">${article.main_body?default('')}
